...
export default function Home() {
  return (
    <div className="flex flex-col">
      ...
      <section className="relative w-full h-[60vh] min-h-[400px] bg-slate-800 flex items-center justify-center border-b-4 border-blue-700">
        {/* Uncomment the Image tag below once you add hero-building.jpg to your public folder */}
        {/* <Image 
        ...
        <div className="absolute inset-0 flex items-center justify-center text-slate-600 font-mono">
          [hero-building.jpg Placeholder - 1920x1080]
        </div>

        <div className="relative z-10 text-center px-4">
          <h1 className="text-4xl md:text-7xl font-extrabold text-white tracking-tighter drop-shadow-lg">
            METRIX <span className="text-blue-400">7.0i</span>
          </h1>
        </div>
      </section>
      ...
      <section className="py-16 px-4 bg-white text-center border-b border-slate-200">
        <div className="max-w-4xl mx-auto">
          <h2 className="text-3xl md:text-5xl font-bold text-slate-900 mb-6 uppercase tracking-tight">
            7th Indian Conference on <br className="hidden md:block"/> Applied Mechanics & Engineering
          </h2>
        ...
        <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <div className="relative aspect-[3/4] bg-white border border-slate-200 shadow-lg p-2 rounded-sm group overflow-hidden">
            <div className="absolute inset-0 bg-slate-100 flex flex-col items-center justify-center text-slate-400 m-2 border-2 border-dashed border-slate-300">
              {/* <Image src="/poster-1.jpg" alt="Inaugural Poster" fill className="object-cover" /> */}
          ...
          <div className="relative aspect-[3/4] bg-white border border-slate-200 shadow-lg p-2 rounded-sm group overflow-hidden">
            <div className="absolute inset-0 bg-slate-100 flex flex-col items-center justify-center text-slate-400 m-2 border-2 border-dashed border-slate-300">
              {/* <Image src="/poster-2.jpg" alt="Schedule Poster" fill className="object-cover" /> */}
      ...
      {/* 5. Important Dates (Table Format) */}
      <section className="py-20 px-4 bg-slate-50">
        <div className="max-w-4xl mx-auto">
            ...
            <table className="w-full text-left border-collapse">
              <tbody className="divide-y divide-slate-200">
                <tr className="hover:bg-slate-50 transition-colors">
                  ...
                  <td className="py-5 px-6 text-blue-700 font-bold w-1/3">June 15, 2026</td>
                </tr>
                <tr className="hover:bg-slate-50 transition-colors">
                  <td className="py-5 px-6 font-semibold text-slate-900">Notification of Acceptance</td>
                  <td className="py-5 px-6 text-blue-700 font-bold">July 30, 2026</td>
                </tr>
                <tr className="hover:bg-slate-50 transition-colors">
